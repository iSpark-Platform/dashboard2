...
const InternshipDetailsArea = ({ course }) => {
                        ...
                        <div className="course-details-content">
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    ...
                                    type="button" role="tab" aria-controls="overview" aria-selected="true" tabIndex={-1}>Overview</button>
                                </li>
                                <li className="nav-item" role="presentation">
                                ...
                                <li className="nav-item" role="presentation">
                                    ...
                                    type="button" role="tab" aria-controls="instructor" aria-selected="false" tabIndex={-1}>Instructor</button>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review" type="button"
                                    role="tab" aria-controls="review" aria-selected="false" tabIndex={-1}>Reviews</button>
                                </li>
                            </ul>
                                    ...
                                    <div className="course-tab-content">
                                        <div className="course-instructor">
                                            <div className="thumbnail">
                                                <img src={`/assets/images/team/team-01/${instructor_img}`} alt="team images" />
                                            </div>
...
export default InternshipDetailsArea;